...
Additionally, the project assumes the availability of a `bash` (or compatible) shell environment.
...
The project can be tested via the invocation shown below:

```
bash execute_e2e_tests.sh
```

![Testing the project](docs/assets/screenshots/04-client-test-scenarios.png)
